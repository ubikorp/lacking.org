...
const getTloPost = async (post: CollectionEntry<'post'>): Promise<Post> => {
...
// this is kept here as an export for reference
...
const load = async function (): Promise<Array<Post>> {
  ...
  const normalizedPosts = posts.map(async (post) => await getTloPost(post));
